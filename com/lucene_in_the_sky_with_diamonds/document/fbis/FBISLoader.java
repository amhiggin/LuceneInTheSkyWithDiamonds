...
public class FBISLoader {
	...
	private String topLevelRegex = "<DOCNO>|</DOCNO>|" + "<HT>|</HT>|" + "<HEADER>|</HEADER>|" + "<TEXT>|</TEXT>|"
			+ "</DOC>|" + "<DATE1>|</DATE1>|" + "<H2>| </H2>|" + "<H3>|</H3>|" + "<TI>|</TI>";
	...
	private Document createDocument(ArrayList<String> sections) {
		 ...
		 * 
		 * TODO: remove tags such <f> or use the function from github
		 */
