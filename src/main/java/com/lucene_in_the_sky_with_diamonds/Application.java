...
public class Application {
  ...
  public static void main(String[] args) {
    try {
      ...
      queryResultsFileName = String.format("%s/output/%s-%s-results.txt",
          Constants.APPLICATION_PATH, args[1], args[2]);
      trecEvalOutputFileName = String.format("%s/output/trec_eval-%s-%s-results.txt",
          Constants.APPLICATION_PATH, args[1], args[2]);
